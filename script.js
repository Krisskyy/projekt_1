...
function button_click(number) {
  ...
  if (
    !inputs[0].classList.contains("border-click") &&
    !inputs[1].classList.contains("border-click") &&
    !inputs[2].classList.contains("border-click")
  ) {
    ...
    points =
      number == "one" && inputs[2].classList.contains("border-click")
        ? 1
        : number == "one"
        ? 0
        : points;
    ...
    points =
      number == "two" && inputs[1].classList.contains("border-click")
        ? points >= 1
          ? 2
          : 1
        : number == "two"
    ...
    points =
      number == "three" && inputs[0].classList.contains("border-click")
        ? points >= 2
          ? 3
          : points == 1
          ? 2
...
for (let i = 0; i < inputs_color.length; i++) {
  inputs_color[i].addEventListener("click", () => {
    ...
    function change_color(number) {
      ...
      inputs_color[i].parentElement.firstElementChild.src =
        "./media/flower-icon-color.svg";
